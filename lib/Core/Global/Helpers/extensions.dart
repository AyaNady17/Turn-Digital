...
extension BuildContextOperations on BuildContext {
  ...
  void showSnackBar({
    ...
    final snackBar = SnackBar(
      content: Text(message, style: Theme.of(this).textTheme.headlineMedium),
      duration: duration,
...
extension PaddingExtension on Widget {
  ...
  Widget paddingLeft(double leftPadding) {
    return Padding(padding: EdgeInsets.only(left: leftPadding.w), child: this);
  }
  ...
  Widget paddingTop(double topPadding) {
    return Padding(padding: EdgeInsets.only(top: topPadding.h), child: this);
  }
